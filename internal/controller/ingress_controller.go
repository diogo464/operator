...
//+kubebuilder:rbac:groups=networking.k8s.io.d464.sh,resources=ingresses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=networking.k8s.io.d464.sh,resources=ingresses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=networking.k8s.io.d464.sh,resources=ingresses/finalizers,verbs=update
